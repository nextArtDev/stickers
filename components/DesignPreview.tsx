...
// http://localhost:3000/configure/preview?id=clwj9rlmi0001d1vud7w7zxd0
import Phone from '@/components/Phone'
import { Button } from '@/components/ui/button'
import { BASE_PRICE, PRODUCT_PRICES } from '@/config/products'
import { cn, formatPrice } from '@/lib/utils'
import { COLORS, FINISHES, MODELS } from '@/validators/option-validator'
import { Configuration, Image } from '@prisma/client'
...
const DesignPreview = ({
  ...
  configuration: Configuration & { imageUrl: Image } & {
      ...
      <div className="mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
        <div className="md:col-span-4 lg:col-span-3 md:row-span-2 md:row-end-2">
          <Phone
            ...
            imgSrc={
              configuration?.croppedImageUrl?.url! || configuration.imageUrl.url
            }
          />
        </div>
